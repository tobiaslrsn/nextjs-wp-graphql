...
/** The Property type */
export type Property = BlockEditorContentNode &
    ContentNode &
    DatabaseIdentifier &
    MenuItemLinkable &
    Node &
...
/** Connection between the Property type and the Property type */
export type PropertyToPreviewConnectionEdge = Edge &
    OneToOneConnection &
    PropertyConnectionEdge & {
...
export type ReusableBlockToRevisionConnectionWhereArgsMetaQuery = {
    metaArray?: InputMaybe<
        Array<InputMaybe<ReusableBlockToRevisionConnectionWhereArgsMetaArray>>
    >;
    relation?: InputMaybe<RelationEnum>;
};
...
export type RootQueryToBlockEditorPreviewConnectionWhereArgsMetaQuery = {
    metaArray?: InputMaybe<
        Array<
            InputMaybe<RootQueryToBlockEditorPreviewConnectionWhereArgsMetaArray>
        >
    >;
    relation?: InputMaybe<RelationEnum>;
};
...
/** Connection between the RootQuery type and the Property type */
export type RootQueryToPropertyConnection = Connection &
    PropertyConnection & {
...
/** An edge in a connection */
export type RootQueryToPropertyConnectionEdge = Edge &
    PropertyConnectionEdge & {
...
export type RootQueryToPropertyConnectionWhereArgsMetaQuery = {
    metaArray?: InputMaybe<
        Array<InputMaybe<RootQueryToPropertyConnectionWhereArgsMetaArray>>
    >;
    relation?: InputMaybe<RelationEnum>;
};
...
export type RootQueryToReusableBlockConnectionWhereArgsMetaQuery = {
    metaArray?: InputMaybe<
        Array<InputMaybe<RootQueryToReusableBlockConnectionWhereArgsMetaArray>>
    >;
    relation?: InputMaybe<RelationEnum>;
};
...
export type RootQueryToRevisionsConnectionWhereArgsMetaQuery = {
    metaArray?: InputMaybe<
        Array<InputMaybe<RootQueryToRevisionsConnectionWhereArgsMetaArray>>
    >;
    relation?: InputMaybe<RelationEnum>;
};
...
export type UserToBlockEditorPreviewConnectionWhereArgsMetaQuery = {
    metaArray?: InputMaybe<
        Array<InputMaybe<UserToBlockEditorPreviewConnectionWhereArgsMetaArray>>
    >;
    relation?: InputMaybe<RelationEnum>;
};
...
export type UserToRevisionsConnectionWhereArgsMetaQuery = {
    metaArray?: InputMaybe<
        Array<InputMaybe<UserToRevisionsConnectionWhereArgsMetaArray>>
    >;
    relation?: InputMaybe<RelationEnum>;
};
